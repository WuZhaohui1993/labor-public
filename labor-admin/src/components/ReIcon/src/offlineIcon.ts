...
import RiFileExcel2Line from "~icons/ri/file-excel-2-line?raw";
import RiUploadCloud2Line from "~icons/ri/upload-cloud-2-line?raw";
...
import RiCodeSSlashLine from "~icons/ri/code-s-slash-line?raw";
import RiUserSettingsLine from "~icons/ri/user-settings-line?raw";
import RiFileList3Line from "~icons/ri/file-list-3-line?raw";
import RiExchangeBoxLine from "~icons/ri/exchange-box-line?raw";
import RiCameraLensLine from "~icons/ri/camera-lens-line?raw";
import RiUserSearchLine from "~icons/ri/user-search-line?raw";
import RiSendPlaneLine from "~icons/ri/send-plane-line?raw";
import RiMenu2Line from "~icons/ri/menu-2-line?raw";
import RiFolderSettingsLine from "~icons/ri/folder-settings-line?raw";
import RiShieldUserLine from "~icons/ri/shield-user-line?raw";
